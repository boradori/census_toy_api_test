...
class TestCountByGender:
    ...
    def test_count_by_gender_returns_correct_values(self, api_url, top_gender, num_of_users):
        test_users = generate_random_users(num_of_users)
        response = make_post_request(api_url, test_users, action_type="CountByGender", top=top_gender)
    ...
    def test_count_by_gender_with_invalid_users_list(self, api_url, top_gender):
    ...
    def test_count_by_gender_with_invalid_action_type(self, api_url, top_gender, action_type):
        test_users = generate_random_users()
        response = make_post_request(api_url, test_users, action_type=action_type, top=top_gender)
    ...
    def test_count_by_gender_without_action_type(self, api_url, top_gender):
        test_users = generate_random_users()
        response = make_post_request(api_url, test_users, action_type=None, top=top_gender)
