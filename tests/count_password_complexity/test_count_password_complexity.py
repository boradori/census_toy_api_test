...
class TestCountPasswordComplexity:
    ...
    def test_count_pw_complexity_returns_correct_values(self, api_url, top_pw_complex, num_of_users):
        ...
        if num_of_users <= 0:
            ...
            expected_length = len(test_users) if top_pw_complex <= 0 or top_pw_complex > len(test_users) \
                else top_pw_complex

            if top_pw_complex <= 0 or top_pw_complex > len(test_users):
        ...
        expected_result = get_sorted_pw_complexity(test_users, top_pw_complex)
